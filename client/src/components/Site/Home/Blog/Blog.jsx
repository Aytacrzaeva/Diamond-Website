    ...
    return (
        <div className="blog">
            ...
            <div className="blog__down">
                ...
                <div className="blog__down__card">
                    <div className="blog__down__card__img">
                        <img src="https://opencart.workdo.io/diamond/image/cache/catalog/blog/4-1000x670.jpg" alt="" />
                    </div>
                    <div className="blog__down__card__items">
                        <div className="blog__down__card__item1">
                        <Link>Best bracelet and necklaces</Link>
                ...
                <div className="blog__down__card">
                    <div className="blog__down__card__img">
                        <img src="https://opencart.workdo.io/diamond/image/cache/catalog/blog/3-1000x670.jpg" alt="" />
                    </div>
                    <div className="blog__down__card__items">
                        <div className="blog__down__card__item1">
                        <Link>Best bracelet and necklaces</Link>
                ...
                <div className="blog__down__card">
                    <div className="blog__down__card__img">
                        <img src="https://opencart.workdo.io/diamond/image/cache/catalog/blog/2-1000x670.jpg" alt="" />
                    </div>
                    <div className="blog__down__card__items">
                        <div className="blog__down__card__item1">
                        <Link>Best bracelet and necklaces</Link>
